        ...
        <section class="w-full py-5 bg-[#F8F2EA] lg:py-10">
            <div class="grid lg:grid-cols-2 items-center justify-items-center gap-5">
                <div class="order-2 lg:order-1 flex flex-col justify-center items-center">
                    ...
                    <button
                        class="rounded-lg text-lg md:text-2xl bg-[#3E5641] text-[#F0F0F0] py-2 px-5 mt-10 hover:bg-[#004D61]">Shop
                        Now</button>
                </div>
                <div class="order-1 lg:order-2">
                    <img class="rounded-lg h-80 w-80 object-cover lg:w-[500px] lg:h-[500px]"
                        src="{{ asset('images/hero_image.jpg') }}" alt="Hero Image">
                </div>
            </div>
        </section>
        {{-- Categories Section --}}
    @endsection
    <div class="w-full rounded-[20px] sm:p-8 p-6">
