            ...
            <div class="w-full md:w-1/2">
                <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input wire:model.live.debounce.100ms="searchCategory" type="text" id="simple-search" placeholder="Search for categories" required=""
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <button wire:confirm="Are you sure, you want to delete?" wire:click="deleteCategory({{ $category->id }})" type="button" data-modal-target="delete-modal" data-modal-toggle="delete-modal"
